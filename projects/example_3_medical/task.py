...
from projects.example_3_medical.model import RootModel
...
class Task(InferenceTask):
    def __init__(self):
        ...
        self.dataset = load_dataset("NovelHacja/RubricHub_v1_config", "medical", split="train", streaming=False).select(range(2))
